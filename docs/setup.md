...
2. From the list of solution pack that appears, search **Outbreak Response - Check Point Quantum Security Gateways Information Disclosure Attack**.
3. Click the **Outbreak Response - Check Point Quantum Security Gateways Information Disclosure Attack** solution pack card.
4. Click **Install** on the lower part of the screen to begin the installation.

## Prerequisites
The **Outbreak Response - Check Point Quantum Security Gateways Information Disclosure Attack** solution pack depends on the following solution packs that are installed automatically & if not already installed.
